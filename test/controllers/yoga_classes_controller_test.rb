...
class YogaClassesControllerTest < ActionController::TestCase
  ...
  test "should create yoga_class" do
    assert_difference('YogaClass.count') do
      post :create, yoga_class: { description: @yoga_class.description, name: @yoga_class.name, user_id: @yoga_class.user_id }
    end
  ...
  test "should update yoga_class" do
    patch :update, id: @yoga_class, yoga_class: { description: @yoga_class.description, name: @yoga_class.name, user_id: @yoga_class.user_id }
    assert_redirected_to yoga_class_path(assigns(:yoga_class))
  end
